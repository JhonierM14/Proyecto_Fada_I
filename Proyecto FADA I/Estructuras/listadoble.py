...
def List_Merge(lista_izq, lista_der):
    merged = None
...
def List_Merge_Sort(lista):
    ...
    lista_izq = List_Merge_Sort(izq) # ordena la mitad izquierda
    lista_der = List_Merge_Sort(der) # ordena la mitad derecha

    return List_Merge(lista_izq, lista_der) # junta las dos mitades ordenadas
